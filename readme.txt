...
Following packages should be installed after that:
 ...
 - control_toolbox - this package contains modules that are useful across all controllers. You can also get sources from here (http://wiki.ros.org/control_toolbox).
 ...
 - scan_tools - this stack contains tools for manipulating sensor_msgs/LaserScan and sensor_msgs/PointCloud messages. And also it contains Andrea Censi's Canonical Scan Matcher realization. You can also get sources from here (http://wiki.ros.org/scan_tools).
...
- *.yaml - parameters of navigation stack. More detailed information see on http://wiki.ros.org/navigation.
